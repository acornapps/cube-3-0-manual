...
**5. 청지윈 builder-api, client-api의 환경 변수 수정.**

cengjiyun-api의 환경변수를 아래 참고해서 수정한다.
...
| CA_PEM | CA 인증키인 ca.crt파일을 base64 encoding해서 입력 <br/>(# cat /root/.docker/ca.crt &#124; base64 -w 0) |
| CERT_PEM | build server cert.pem파일을 base64 encoding해서 입력 <br/>(# cat /root/.docker/cert.pem &#124; base64 -w 0) |
| KEY_PEM | build server key.pem파일을 base64 encoding해서 입력 <br/>(# cat /root/.docker/key.pem &#124; base64 -w 0) |
