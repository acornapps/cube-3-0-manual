...
| CA_PEM | CA 인증키인 ca.crt파일을 base64 encoding해서 입력 (# cat /root/.docker/ca.crt &#124; base64 -w 0) |
| CERT_PEM | build server cert.pem파일을 base64 encoding해서 입력 (# cat /root/.docker/cert.pem &#124; base64 -w 0) |
| KEY_PEM | build server key.pem파일을 base64 encoding해서 입력 (# cat /root/.docker/key.pem &#124; base64 -w 0) |
